    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Pengajar Edit</h3>
            </div>
			<?php echo form_open('pengajar/edit/'.$pengajar['id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_mapel" class="form-control">
								...
								{
									$selected = ($mapel['id'] == $pengajar['id_mapel']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_kelas" class="form-control">
								...
								{
									$selected = ($kela['id'] == $pengajar['id_kelas']) ? ' selected="selected"' : "";
