				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="parrent_id" value="<?php echo ($this->input->post('parrent_id') ? $this->input->post('parrent_id') : $category['parrent_id']); ?>" class="form-control" id="parrent_id" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="meta_title" value="<?php echo ($this->input->post('meta_title') ? $this->input->post('meta_title') : $category['meta_title']); ?>" class="form-control" id="meta_title" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="content" class="form-control" id="content"><?php echo ($this->input->post('content') ? $this->input->post('content') : $category['content']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
