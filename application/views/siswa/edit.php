				...
				<div class="row clearfix">
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="text" name="id_user" value="<?php echo ($this->input->post('id_user') ? $this->input->post('id_user') : $siswa['id_user']); ?>" class="form-control" id="id_user" />
						</div>
					</div>
					<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="text" name="hp" value="<?php echo ($this->input->post('hp') ? $this->input->post('hp') : $siswa['hp']); ?>" class="form-control" id="hp" />
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="text" name="tanggal_lahir" value="<?php echo ($this->input->post('tanggal_lahir') ? $this->input->post('tanggal_lahir') : $siswa['tanggal_lahir']); ?>" class="form-control" id="tanggal_lahir" />
						</div>
					</div>
					<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="text" name="biografi" value="<?php echo ($this->input->post('biografi') ? $this->input->post('biografi') : $siswa['biografi']); ?>" class="form-control" id="biografi" />
						</div>
					</div>
					<div class="col-md-12">
						<label for="url_fb" class="control-label">Url Fb</label>
						<div class="form-group">
							<input type="text" name="url_fb" value="<?php echo ($this->input->post('url_fb') ? $this->input->post('url_fb') : $siswa['url_fb']); ?>" class="form-control" id="url_fb" />
						</div>
					</div>
					<div class="col-md-12">
						<label for="url_twitter" class="control-label">Url Twitter</label>
						<div class="form-group">
							<input type="text" name="url_twitter" value="<?php echo ($this->input->post('url_twitter') ? $this->input->post('url_twitter') : $siswa['url_twitter']); ?>" class="form-control" id="url_twitter" />
						</div>
					</div>
					<div class="col-md-12">
						<label for="url_instagram" class="control-label">Url Instagram</label>
						<div class="form-group">
							<input type="text" name="url_instagram" value="<?php echo ($this->input->post('url_instagram') ? $this->input->post('url_instagram') : $siswa['url_instagram']); ?>" class="form-control" id="url_instagram" />
						</div>
					</div>
					<div class="col-md-12">
						<label for="url_youtube" class="control-label">Url Youtube</label>
						<div class="form-group">
							<input type="text" name="url_youtube" value="<?php echo ($this->input->post('url_youtube') ? $this->input->post('url_youtube') : $siswa['url_youtube']); ?>" class="form-control" id="url_youtube" />
						</div>
					</div>
				</div>
			</div>
