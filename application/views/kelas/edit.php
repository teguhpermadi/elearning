    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Kela Edit</h3>
            </div>
			<?php echo form_open('kelas/edit/'.$kela['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tingkat" class="form-control">
								...
								{
									$selected = ($value == $kela['tingkat']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nama" value="<?php echo ($this->input->post('nama') ? $this->input->post('nama') : $kela['nama']); ?>" class="form-control" id="nama" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="kode" value="<?php echo ($this->input->post('kode') ? $this->input->post('kode') : $kela['kode']); ?>" class="form-control" id="kode" />
